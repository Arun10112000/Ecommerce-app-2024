...
{/*     
    ...
    <div className="row mt-3 home-page">
      ...
      {/* category filter */}
        ...
        <div className="d-flex flex-column m-3" style={{alignItems:"center"}}>
        {categories?.map((c) => (
              <Checkbox
          ...
          <div className="d-flex flex-column m-3" style={{alignItems:"center"}}>
            <Radio.Group onChange={(e) => setRadio(e.target.value)}>
              {Prices?.map((p) => (
                <div key={p._id}>
                  <Radio value={p.array} className='ant-radio-wrapper'>{p.name}</Radio>
                </div>
              ))}
            </Radio.Group>
          </div>
      ...
      <div className="d-flex flex-wrap main-div">
      {products?.map((p) => (
